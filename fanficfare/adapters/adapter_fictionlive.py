...
class FictionLiveAdapter(BaseSiteAdapter):
    ...
    def extract_metadata(self, data, get_cover):
        ...
        # ct <= rt <= cht <= ut
        self.story.setMetadata("dateUpdated", self.parse_timestamp(data['cht'] if 'cht' in data else data['ut']))
...
# add support for fanficfare include_dice_rolls option? -- but they're just default user-comments / text
