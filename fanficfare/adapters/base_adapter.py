...
<p>Error:<br><pre>%s</pre></p>
    ...
    def _do_utf8FromSoup(self,url,soup,fetch=None,allow_replace_br_with_p=True):
        ...
        # replaces <div> tags with <p> tags.
        # adds proper paragraph spacing to some chapters on some royalroad stories (as of early 2022)
        if self.getConfig("div_to_p", default=False):
