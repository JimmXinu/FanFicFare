...
class BloodshedverseComAdapter(BaseSiteAdapter):
    ...
    def extractChapterUrlsAndMetadata(self):
        ...
        query_data = urllib.parse.parse_qs(self.chapterUrls[0][1])
        story_no = query_data['no'][0]
        ...
        # scrape the metadata
        author_url = urllib.parse.urljoin(self.url, soup.find('a', {'class': 'headline'})['href'])
        ...
        self.story.setMetadata('authorUrl', urllib.parse.urljoin(self.url, author_anchor['href']))
